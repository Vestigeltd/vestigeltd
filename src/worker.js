...
const VESTIGE_ANALYTICS_EVENTS = new Set([
  ...
  'checkout_started','payment_claimed','payment_confirmed'
]);
...
async function analyticsSummary(env,days=30){
  ...
  return {
    success:true,days:safeDays,events:counts,uniqueSessions:sessions.size,
